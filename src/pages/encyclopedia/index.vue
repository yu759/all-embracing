  ...
  <div class="encyclopedia-layout">
    <aside class="sidebar" :class="{ collapsed: isCollapsed }">
      <div class="sidebar-header">
        <span v-if="!isCollapsed" class="sidebar-title">探索目录</span>
      ...
      <nav class="side-nav">
        <router-link to="/encyclopedia/flower" class="side-item">
          ...
          <span v-if="!isCollapsed" class="label">鲜花百科</span>
        </router-link>

        <router-link to="/encyclopedia/animals" class="side-item">
          <!-- <span class="icon">🐆</span> -->
          <span v-if="!isCollapsed" class="label">动物百科</span>
        </router-link>

        <router-link to="/encyclopedia/constellation" class="side-item">
          <!-- <span class="icon">✨</span> -->
          <span v-if="!isCollapsed" class="label">星座百科</span>
        </router-link>
      </nav>
    </aside>
